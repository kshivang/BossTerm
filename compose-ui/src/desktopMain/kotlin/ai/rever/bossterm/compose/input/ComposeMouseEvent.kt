...
import ai.rever.bossterm.core.input.MouseEvent as CoreMouseEvent
import ai.rever.bossterm.core.input.MouseWheelEvent as CoreMouseWheelEvent
import ai.rever.bossterm.terminal.emulator.mouse.MouseButtonCodes
import ai.rever.bossterm.terminal.emulator.mouse.MouseButtonModifierFlags

/**
 * Creates a BossTerm MouseEvent from Compose button code and modifiers.
 */
...
/**
 * Creates a BossTerm MouseWheelEvent from Compose button code and modifiers.
 */
...
/**
 * Converts Compose PointerButton to BossTerm MouseButtonCodes constant.
 *
...
/**
 * Converts Compose PointerEvent keyboard modifiers to BossTerm mouse modifier flags.
...
/**
 * Creates a BossTerm MouseWheelEvent from a Compose PointerEvent.
 *
