...
data class TerminalSettingsOverride(
    ...
    val useNativeContextMenus: Boolean? = null,
    ...
    val cursorFocusedAlpha: Float? = null,
    val cursorUnfocusedAlpha: Float? = null,
...
fun TerminalSettings.withOverrides(override: TerminalSettingsOverride?): TerminalSettings {
    ...
    return copy(
        ...
        useNativeContextMenus = override.useNativeContextMenus ?: useNativeContextMenus,
        ...
        cursorFocusedAlpha = override.cursorFocusedAlpha ?: cursorFocusedAlpha,
        cursorUnfocusedAlpha = override.cursorUnfocusedAlpha ?: cursorUnfocusedAlpha,
